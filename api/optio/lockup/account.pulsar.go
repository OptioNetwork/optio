...
func (x *fastReflection_Account) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "optio.lockup.Account.lockups":
...
func (x *Lockup) slowProtoReflect() protoreflect.Message {
	mi := &file_optio_lockup_account_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Lockup) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message optio.lockup.Lockup does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Lockup) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message optio.lockup.Lockup does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Lockup) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in optio.lockup.Lockup", d.FullName()))
	}
	panic("unreachable")
}
...
var file_optio_lockup_account_proto_rawDesc = []byte{
	...
	0x70, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfc,
	0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x49, 0x0a, 0x0c, 0x62, 0x61,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x3c, 0x0a, 0x07, 0x6c, 0x6f, 0x63, 0x6b, 0x75, 0x70, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x2e, 0x6c,
	0x6f, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x4c, 0x6f,
	0x63, 0x6b, 0x75, 0x70, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x6c, 0x6f, 0x63, 0x6b,
	0x75, 0x70, 0x73, 0x1a, 0x50, 0x0a, 0x0c, 0x4c, 0x6f, 0x63, 0x6b, 0x75, 0x70, 0x73, 0x45, 0x6e,
...
var file_optio_lockup_account_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_optio_lockup_account_proto_goTypes = []interface{}{
	(*Account)(nil),             // 0: optio.lockup.Account
	(*Lockup)(nil),              // 1: optio.lockup.Lockup
	nil,                         // 2: optio.lockup.Account.LockupsEntry
...
func file_optio_lockup_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_optio_lockup_account_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Lockup); i {
			case 0:
				return &v.state
			case 1:
