...
// [license-types] is a comma-delimited list of license type IDs (e.g. "optio.node,optio.validator").
...
Example:
  optiod tx licenses set-admin-key optio1abc... issue,revoke optio.node,optio.validator \
    --from node --gas auto --gas-adjustment 1.5 --fees 100000uOPT -y`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Build one grant per permission
...
Example:
  optiod tx licenses batch-issue-license optio.node \
    optio1abc...:2025-01-01:2026-01-01 \
    optio1def...:2025-01-01 \
    --from admin --gas auto --fees 100000uOPT -y`,
